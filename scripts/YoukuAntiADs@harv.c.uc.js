...
(function() {
    ...
    YoukuAntiADs.prototype = {
        SITES: {
            'youku_loader': {
                'player': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/loader.swf',
                're': /http:\/\/static\.youku\.com(\/v[\d\.]+)?\/v\/swf\/loader\.swf/i
            },
            'youku_player': {
                'player': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/player.swf',
            ...
            'iqiyi': {
                ...
                'player1': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/iqiyi5.swf',
                'player2': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/iqiyi.swf',
                're': /http:\/\/www\.iqiyi\.com\/player\/\d+\/player\.swf/i
            },
            'tudou': {
                'player': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/tudou.swf',
                're': /http:\/\/js\.tudouui\.com\/.*portalplayer[^\.]*\.swf/i
            },
            'tudou_olc': {
                'player': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/olc_8.swf',
                're': /http:\/\/js\.tudouui\.com\/.*olc[^\.]*\.swf/i
            },
            'tudou_sp': {
                'player': 'https://git.oschina.net/kawaiiushio/antiad/raw/master/sp.swf',
